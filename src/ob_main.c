...
MODULE_LICENSE("GPL");
MODULE_FIRMWARE(OB_FW_UCODE42_NAME);
MODULE_FIRMWARE(OB_FW_UCODE42_NAME_LEGACY);
MODULE_FIRMWARE(OB_FW_AC1INITVALS42_NAME);
MODULE_FIRMWARE(OB_FW_AC1BSINITVALS42_NAME);
